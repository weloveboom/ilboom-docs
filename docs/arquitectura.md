...
| **GCP Artifact Registry** | Registro de imágenes Docker (`us-west1-docker.pkg.dev`). | Docker + GitHub Actions |
...
- **Container Registry**: GCP Artifact Registry (`us-west1-docker.pkg.dev`)
